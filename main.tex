...
% \includeonly{textuais/cap4_problema.tex}
% \includeonly{textuais/cap5_implementacao.tex}
% \includeonly{textuais/cap6_experimentos_e_resultados.tex}
% \includeonly{textuais/cap7_conclusao.tex}
...
% \gls{SGBD} Sistema de Gerenciamento de Banco de Dados 
...
% Cap. 1 - Introdução
\include{textuais/cap1_introducao}

% Cap. 2 - Teoria (Fundamentação Teórica)
\include{textuais/cap2_teoria}

% Cap. 3 - Trabalhos Relacionados
\include{textuais/cap3_trabalhos_relacionados}

% Cap. 4 - Problema
% \include{textuais/cap4_problema}

% Cap. 4 - Nurse: uma aplicação para produtividade em vacinações
\include{textuais/cap4_implementacao}

% Cap. 5 - Experimentos e Resultados
\include{textuais/cap5_experimentos_e_resultados}

% Cap. 6 - Conclusão
\include{textuais/cap6_conclusao}
...
% Imagem única
% \begin{figure}[h!]
%   \includegraphics[width=1\textwidth, keepaspectratio=true]{figuras/CAP5/5_1_describe.png}
%   \centering
%   \caption[Descrição estatística das variáveis contínuas.]{Descrição estatística das variáveis contínuas.}
%   \fonte{Próprio autor}
%   \label{fig:describe}
% \end{figure}
% \FloatBarrier

%  Conjunto de imagens uma abaixo da outra.
% \begin{figure}[h!]
%   \centering
%           \subfloat[Deionizador]{\includegraphics[width=0.51\columnwidth]{figuras/CAP6/6_scanuplam2.jpeg}}
%             \qquad
%             \subfloat[Osmose reversa]{\includegraphics[width=0.51\columnwidth]{figuras/CAP6/6_scanuplam_1_2.jpeg}}
%     \caption[Indicadores de histórico semanal dos estados das máquinas.]{Indicadores de histórico semanal dos estados das máquinas.}
%   \fonte{Captura de tela do software SCANUPLAM.} 
  
%   \label{fig:resultados-scanuplam_estados}
% \end{figure}
% \FloatBarrier
