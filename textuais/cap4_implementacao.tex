...
\begin{figure}[ht!]
  \centering
          \subfloat[Tela \textbf{Home}]{\includegraphics[width=0.25\columnwidth]{figuras/cap4/4_2_home_screen_2.png}}
            \qquad
          \subfloat[Tela \textbf{listagem de entidades}]{\includegraphics[width=0.25\columnwidth]{figuras/cap4/4_2_entities_screen.png}}
            \qquad
          \subfloat[Tela \textbf{exportação de dados}]{\includegraphics[width=0.25\columnwidth]{figuras/cap4/4_2_export_screen_4.png}}
...
\begin{figure}[ht!]
  \centering
          \subfloat[Tela da lista de campanhas cadastradas]{\includegraphics[width=0.25\columnwidth]{figuras/cap4/4_2_campaign_list_screen.png}}
            \qquad
          \subfloat[Tela de cadastro de nova campanha]{\includegraphics[width=0.25\columnwidth]{figuras/cap4/4_2_campaign_form_2.png}}
