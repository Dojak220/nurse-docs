...
O cenário em que o profissional da saúde não tem acesso à internet é o centro do problema relatado neste trabalho. Isso ocorre, seja porque o estabelecimento de atuação desse profissional não está devidamente equipado ou porque as salas de vacinação são em campo, ou seja, fora no estabelecimento. E é em cima disso que a solução desenvolvida deverá agir.

Levando esse cenário supracitado em consideração, existem alguns pontos propensos a erro no processo que poderiam ser evitados. Na coleta de dados, pelo fato da utilização de formulários impressos, existe a possibilidade de equívoco na escrita das informações e/ou na digitação das mesmas no momento em que esses dados são repassados para o sistema online.
