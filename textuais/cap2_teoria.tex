...
\begin{figure}[h!]
  ...
  \centering
  \caption[Plataformas de compilação do Dart]{Plataformas de compilação do Dart}
  % \fonte{Site oficial da linguagem Dart}
...
O \textit{framework} recebe inspiração do React e, dessa forma, utiliza-se de Widgets para compor os elementos visuais das aplicações, assim como os estados dos mesmos. % ref: https://docs.flutter.dev/development/ui/widgets-intro 01/11/2022
Estes Widgets devem ser responsáveis por gerir, com boa performance, a renderização dos elementos na tela, suas animações e também controlar as interações do usuário com a aplicação.
